 ...
 */
final class Version20210316230206 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ingredient ADD type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_6BAF7870C54C8C93 ON ingredient');
        $this->addSql('ALTER TABLE ingredient DROP type_id');
    }
}
